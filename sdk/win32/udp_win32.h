...
bool setup_lidar(int fd_udp, const char* ip, int port, int unit_is_mm, int with_confidence, int resample, int with_deshadow,int should_post, int with_smooth, int init_rpm, char* version);
